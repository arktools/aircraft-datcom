      SUBROUTINE VTLIFT
C
C***  COMPUTE SUPERSONIC VERTICAL TAIL CL
C
      REAL MACH,KSHARP
     ...
     1            (AR,AVT(7)),(TRATIP,AVT(25)),(COSLE,AVT(61)),
     2            (DELTAY,VTIN(17)),(SPANO,VTIN(2)),(TANLEO,AVT(86)),
     3            (TANTEO,AVT(104)),(CB,VTIN(5)),(CT,VTIN(1)),
     4            (SW,SREF),(TANLEI,AVT(62)),(TANTEI,AVT(80)),
     5            (SWTEI,AVT(76)),(SWTEO,AVT(100)),(KSHARP,VTIN(71)),
     5            (SPANS,WINGIN(3))
      EQUIVALENCE (D13246(1),DUMY1(1)),(D13246(185),DUMY2(1)),
     1            (D13246(369),DUMY3(1)),(D13246(553),DUMY4(1)),
     2            (D13246(737),DUMY5(1)),(D13246(921),DUMY6(1))
      DATA Q3250A/4H4.1.,4H3.2-,4H60A /,Q3246A/4H4.1.,4H3.2-,4H56A /,
     1     Q3250B/4H4.1.,4H3.2-,4H60B /,Q3246G/4H4.1.,4H3.2-,4H56G /,
     2     Q246AF/4H4.1.,4H3.2-,4H56A-,4HF   /,ROUTID/4HVTLI,4HFT  /,
...
C
C              FIGURE 4.1.3.2-63 (CN1=CNA/A)   EXTENSION COMPONENT
C
