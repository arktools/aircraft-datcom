...
C
C*** COMPUTES TRANSONIC H.T. LIFT SLOPE,CLMAX,ALPHA CLMAX,AND CD0
...
C
     ...
     2TRA(9)),(CLAFBT,TRA(10)),(MACH,TRA(4)),(CLAFB,TRA(12)),(CLAA,TRA
     ...
     1(ALCLMT,TRA(37)),(CLMAXT,TRA(38)),(RLCOFF,TRA(39)),(RNN,TRA(40)),
     2(RL,TRA(41)),(CF,TRA(42)),(CDW2(1),TRA(43)),
     3(CDW,TRA(67)),(CDF,TRA(68)),(CD0W,WING(1)),(CLAW6,TRA(70))
     4,(CLABM6,BODY(101)),(CLABD,BODY(101)),(CMAB,BODY(121))
     5,(CDPB,TRA(80)),(CDBFIG,TRA(81)),(CDBB,TRA(76)),(CDWB,TRA(77))
     6,(CD0B,TRA(78)),(CDJB(1),BODY(1)),(CD0WB,BW(1))
     7,(CDFB,TRA(79)),(DCLA14,TRA(82))
