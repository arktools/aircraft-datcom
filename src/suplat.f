...
C
     ...
     1),(AR,A(120)),(TANLE,A(62)),(XW,SYNA(2)),(CR,WINGIN(6)),
     ...
     1  (SHB(1),HTIN(115)),(SEXT(1),HTIN(135))
...
C
     ...
     1Q225AE/4H7.1.,4H2.2-,4H25AE/,Q52318/4H5.2.,4H3.1-,4H8   /,Q125OO/
     24H5.3.,4H1.1-,4H25OO/
...
C
C     ----FIGURE 5.3.1.1-25OO APPARENT MASS FACTORS
C
...
C                      FIGURE 7.1.2.2-25A-E  (CLPTOA)
     ...
     10,0,0,0,2,2,0,0,Q225AE,3,ROUTID)
...
C
      RNN=FLC(I +42)*RLB
C                          EQUATION FOR FIGURE 5.2.3.1-9 KRL
...
C
 ...
 1080 CONTINUE
C
C       ***HORIZONTAL TAIL ADDED TO WING-BODY***
C
      IF(.NOT.HTPL)GO TO 1110
      RH= HTIN(4)-HTIN(3)
C
C              FIGURE 5.3.1.1-25OO (KH(B))HL=RKHBHL
C
     ...
     1            0,0,0,0,0,0,0,0,Q125OO,3,ROUTID)
      GO TO 1100
 1090 VAR(1)=ARG
      LGH(1)=8
