...
C
C***  COMPUTES SUPERSONIC HORIZONTAL TAIL CL,CLA AND CMA
C
     ...
     3,DL3359(50),ALPHAJ(20),CNAAA(20),T61A(9),SLOPE(9)
     ...
     1          T422AF(18),DUMY7(65),DUMY8(91),DUMYA(108),DUMYB(108)
...
C
C************** A IN THIS ROUTINE CORRESPONDS TO AHT ELSEWHERE *********
C
     ...
     1STG(88)),(CDF,STG(87)),(SRSTAR,A(3)),(CBARI,A(15))
     2,(CBARO,A(17)),(RNI,STG(86)),(RNO,STG(85)),(CFI,STG(84)),(CFO,
     3STG(83)),(SISTAR,A(1)),(SOSTAR,A(2)),(P,STG(82)),(DRAGC,STG(81)
     4),(CDO,STG(80)),(CDW,STG(79)),(CDL(1),STG(53)),(CD(1),HT(1))
     ...
     1,(TRATIP,A(25)),(BOVERT,STG(2)),(CNNNT,STG(3)),(COSLE,A(61)),
     2(DELTAY,HTIN(17)),(BCNA,STG(4)),(DELTYT,STG(8)),(DELTDT,STG(9)),
     3(E,STG(11)),(CC,STG(12)),(ALSCHD(1),FLC(23)),(ALPHAI,SYNA(8)),
     4(ALPHAJ(1),STG(33)),(CNAAA(1),STG(13)),(SINLE,A(60))
     5,(DETACH,STG(94)),(CNAAST,STG(116)),(DETALP,STG(117))
      EQUIVALENCE (CNTHRY,STG(5)),(CNA1,STG(7)),(TLE192,STG(10)),
     1(RMACH,STG(93)),(CN(1),HT(61)),(CL(1),HT(21)),(DETANG,STG(115)),
     2(XACCRO,STG(78))
      EQUIVALENCE (SPAN,HTIN(4)),(SPANO,HTIN(2)),(CRBW,STG(118))
     1,(TANTEO,A(104)),(CB,HTIN(5)),(CT,HTIN(1)),(TAPBW,STG(121))
     2,(TANLEI,A(62)),(TANTEI,A(80)),(CN1,STG(127)),(CN2,STG(128)),
     3(ARBW,STG(120)),(CLEBW,STG(122)),(CRGLV,STG(123)),(SGLV,STG(124))
     4,(ARGLV,STG(125)),(BE,STG(126)),(CNAE,STG(129)),(CNAGLV,STG(130))
     5,(CNABW,STG(131)),(CLEGLV,STG(132)),(TANLEO,A(86)),(DETXCG,A(173))
      EQUIVALENCE (ARSTAR,A(7)),(XACCR,STG(134)),(DCMCL,STG(135)),
     1(CRSTAR,A(10)),(CMA,STG(136)),(ARIP,A(5))
     2 ,(TAPIP,A(26)),(CNCNTI,STG(137)),(TAPOP,A(169)),(COSLEO,A(85)),
     3(AROP,A(168)),(SI,A(1)),          (CNCNTO,STG(138)),(CNATI,STG(139
     4)),(CNATO,STG(140)),(CNAI,STG(92)),(CNAO,STG(91))
...
C
 ...
 1455 CONTINUE
     ...
     1          XACCR = HTIN(MIDX+71)*A(122)/CRSTAR
      IF(PITCH)GO TO 1470
      GO TO 1490
