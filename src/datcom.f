...
C
      LOGICAL IM, IRN, IATM
C
      OPEN(UNIT=5,  NAME='for005.dat', STATUS='OLD')
      OPEN(UNIT=6,  NAME='for006.dat', STATUS='UNKNOWN')
      OPEN(UNIT=8,  NAME='for008.dat', STATUS='SCRATCH')
      OPEN(UNIT=9,  NAME='for009.dat', STATUS='SCRATCH')
      OPEN(UNIT=10, NAME='for010.dat', STATUS='SCRATCH')
      OPEN(UNIT=11, NAME='for011.dat', STATUS='SCRATCH')
      OPEN(UNIT=12, NAME='for012.dat', STATUS='SCRATCH')
      OPEN(UNIT=13, NAME='for013.dat', STATUS='UNKNOWN')
      OPEN(UNIT=14, NAME='for014.dat', STATUS='UNKNOWN')
C
