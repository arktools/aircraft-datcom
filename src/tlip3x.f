...
C
C***  LINEAR INTERPOLATION OF PACKED TABLE Y=F(X1,X2,X3)
C
C AJT DIMENSION Y(2),X1(2),X2(2),X3(2),NP1(7),DA(3),MESS(20),ROUT(2)
      DIMENSION Y(2),X1(*),X2(*),X3(*),NP1(7),DA(3),MESS(*),ROUT(*)
