      SUBROUTINE TRHTCM
C
C*** COMPUTES TRANSONIC H.T. AND H.T. BODY PITCHING MOMENT SLOPES
C
      DIMENSION ROUTID(2)
...
C
C     NOTE:  THIS ROUTINE IS THE SAME AS THE ROUTINE USED FOR WINGS.
C            THIS IS WHY THE VARIABLE XW IS IN THE PLACE OF XH IN THE
C            ABOVE COMMON SYNTSS. THIS ALLOWS XW IN THE ROUTINE TO NOT
C            HAVE TO BE CHANGED.  THIS IS DONE IN SEVERAL PLACES IN
C            THIS PROGRAM
C
